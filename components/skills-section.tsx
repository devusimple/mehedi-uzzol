...
const skillCategories = [
  {
    title: "Frontend",
    skills: [
      { name: "React + Next", level: 90, color: "bg-blue-500" },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Flutter", level: 85, color: "bg-indigo-500" },
    ],
  },
  {
    title: "Data & AI",
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Drizzle ORM", level: 85, color: "bg-purple-600" },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "SEO & DM", level: 82, color: "bg-green-600" },
    ],
  },
];
